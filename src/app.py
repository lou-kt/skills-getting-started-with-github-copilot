...
activities = {
    ...
    "Basketball Club": {
        "description": "Basketball drills, scrimmages, and fitness training",
    ...
    "Drama Workshop": {
        "description": "Acting exercises, scene study, and stage production",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["sophia@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice persuasive speaking and competitive debate tournaments",
